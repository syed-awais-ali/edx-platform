...
from lms.djangoapps.course_blocks.transformers.start_date import StartEndDateFieldTransformer
...
SUPPORTED_FIELDS = [
    ...
    SupportedFieldType('start', StartEndDateFieldTransformer),
    SupportedFieldType('end', StartEndDateFieldTransformer),

...
class GradebookTests(ModuleStoreTestCase):
    ...
    def _create_course(self, start=None, end=None):
        ...
        self.problem_progress_summary = {
            ...
            "graded": True,
            "format": "Homework",
            "section_total": [0.75, 1.0, False, "homework problem 1", None],
            "due": None,
            "scores": [[0.75, 1.0, True, "homework problem 1", None]]
        }
        ...
        self.problem2_progress_summary = {
            ...
            "graded": True,
            "format": "Homework",
            "section_total": [0.95, 1.0, False, "homework problem 2", None],
            "due": None,
            "scores": [[0.95, 1.0, True, "homework problem 2", None]]
        }
        ...
        self.problem3_progress_summary = {
            ...
            "graded": True,
            "format": "Lab",
            "section_total": [0.86, 1.0, False, "lab problem 1", None],
            "due": None,
            "scores": [[0.86, 1.0, True, "lab problem 1", None]]
        }
        ...
        self.problem4_progress_summary = {
            ...
            "graded": True,
            "format": "Midterm Exam",
            "section_total": [0.92, 1.0, False, "midterm problem 2", None],
            "due": None,
            "scores": [[0.92, 1.0, True, "midterm problem 2", None]]
        }
        ...
        self.problem5_progress_summary = {
            ...
            "graded": True,
            "format": "Final Exam",
            "section_total": [0.87, 1.0, False, "final problem 2", None],
            "due": None,
            "scores": [[0.87, 1.0, True, "final problem 2", None]]
        }
